...
const Player = (function(){
    const Player = function Player(name, skill, stamina, weapon, armor) {
        this.name = name;
        this.skill = skill;
    ...
    Player.prototype.weapon = this.weapon;
    Player.prototype.name = this.name;

    Player.prototype.isDead = function isDead() {
        return this.stamina <= 0;
    }

    Player.prototype.hitOpponent = function hitOpponent() {
        return (Math.floor(Math.random()*12)+1) <= this.skill;
    }

    Player.prototype.takeHit = function takeHit(hitWith) {
